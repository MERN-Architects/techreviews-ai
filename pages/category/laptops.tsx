...
export default function LaptopsCategoryPage() {
  ...
  const laptopProducts = productsData.products.filter(p => p.category === 'Laptops');
  ...
  return (
    <Layout>
      <Head>
        <title>Laptop Reviews & Comparisons | TechReviews.AI</title>
        <meta
          name="description"
          content="Expert laptop reviews and comparisons. Find the perfect laptop for your needs, from gaming to business and everything in between."
        />
        <meta name="keywords" content="laptop reviews, gaming laptops, business laptops, laptop comparisons, laptop buying guide" />
        <meta property="og:title" content="Laptop Reviews & Comparisons | TechReviews.AI" />
        <meta property="og:description" content="Expert laptop reviews and comparisons. Find the perfect laptop for your needs, from gaming to business and everything in between." />
        <meta property="og:image" content="/images/placeholder.jpg" />
        <meta property="og:type" content="website" />
        <link rel="canonical" href="https://techreviews.ai/category/laptops" />
      </Head>
      ...
      <section className="relative h-[300px] -mt-8 mb-12 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl">
            ...
            >
              <span className="text-white text-lg">💻 Laptops</span>
            </motion.div>
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="mb-12 bg-gradient-to-br from-gray-50 to-primary-50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose Our Reviews</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                title: 'Expert Analysis',
                description: 'In-depth testing and professional analysis of each laptop.',
                icon: '🔍'
              },
              {
                title: 'Fair Comparisons',
                description: 'Side-by-side comparisons to help you decide.',
                icon: '⚖️'
              },
              {
                title: 'Latest Models',
                description: 'Reviews of the newest laptops in the market.',
                icon: '🆕'
              }
            ].map((feature) => (
              <motion.div
        ...
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-br from-primary-600 to-secondary-600 rounded-2xl p-8 text-white text-center">
            ...
            <p className="text-lg mb-6">
              Get the latest laptop reviews and buying guides delivered to your inbox.
            </p>
